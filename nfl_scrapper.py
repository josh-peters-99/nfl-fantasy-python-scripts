...
def insert_player_data(player_data: List[List[str]], db_name: str, collection_name: str) -> None:
    ...
    for data in player_data:
        ...
        # Use 'player_name' and 'team' as a unique identifier to find and update existing document
        filter_query = {'player_name': data[0], 'team': data[2]}

        # Update the document if it exists, otherwise insert a new one (upsert=True)
